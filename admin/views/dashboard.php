...
// Variables: $summary, $top_linked, $broken_links, $last_scan, $current_tab
?>
            ...
            <div class="dil-card <?php echo ! empty( $broken_links ) ? 'dil-card-danger' : ''; ?>">
                ...
                <?php else : ?>
                    <table class="dil-table">
                        ...
                        <tbody>
                            <?php foreach ( array_slice( $broken_links, 0, 10 ) as $link ) : ?>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <code><?php echo esc_html( $link['anchor_text'] ?: $link['link_url'] ); ?></code>
                                    </td>
                                    <td>
                                        <span class="dil-status-badge dil-status-broken">
                                            <?php echo esc_html( $link['target_status'] ?? 'deleted' ); ?>
                                        </span>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
