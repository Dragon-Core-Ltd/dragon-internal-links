...
class Scheduler {
    ...
    public function run_scheduled_scan(): void {
        error_log( 'DIL: Starting scheduled scan at ' . current_time( 'mysql' ) );
        ...
        error_log( "DIL: Scan complete. Scanned {$result['total']} posts, generated {$suggestions} suggestions in {$duration}s" );
